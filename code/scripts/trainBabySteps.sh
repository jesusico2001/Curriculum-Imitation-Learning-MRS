...
python3 TrainModel_babySteps.py --policy $policy --architecture $architecture --nAttLayers $nAttLayers \
    --nEpochs $nEpochs --numTrain 20000 --numVal 2000 --maxNumSamples $maxNumSamples --seed_train 42 \
